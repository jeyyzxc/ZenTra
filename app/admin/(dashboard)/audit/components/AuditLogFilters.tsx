...
import type { AuditFilters, AuditUserOption } from '../types';
...
function formatRole(value: string) {
  ...
  return value === 'SYSTEM'
    ? 'System'
    : value.toLowerCase().replace(/\b\w/g, (letter) => letter.toUpperCase()).replace(/\bN8n\b/g, 'n8n').replace(/\bAi\b/g, 'AI');
}
  ...
  return (
    <div className="rounded-2xl border border-white/70 bg-white/80 p-4 shadow-sm dark:border-white/10 dark:bg-white/5">
      ...
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder={isSuperAdmin ? 'Search user, module, or description...' : 'Search your modules or descriptions...'}
        ...
        {isSuperAdmin && (
          <>
            <SelectField label="User" value={filters.userId} onChange={(value) => onChange('userId', value)}>
            ...
            <SelectField label="Role" value={filters.userRole} onChange={(value) => onChange('userRole', value)}>
        ...
        <SelectField label="Action Type" value={filters.action} onChange={(value) => onChange('action', value)}>
        ...
        <SelectField label="Module" value={filters.module} onChange={(value) => onChange('module', value)}>
