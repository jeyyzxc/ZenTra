      ...
      <div className="w-full relative z-10 bg-[#FBF4C4] pb-24">
        <div className="max-w-5xl mx-auto px-6 pt-20">
          <div className="font-serif text-black">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 mt-10 tracking-wide">1. Acceptance of Terms</h2>
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 mt-10 tracking-wide">2. Reservation Policies</h2>
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 mt-10 tracking-wide">3. Cancellations & Refunds</h2>
