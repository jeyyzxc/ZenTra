...
export default function SpacesSection() {
  return (
    <section className="bg-zentra-bg w-full px-4 py-8 md:px-12">
      <div className="max-w-7xl mx-auto">
        <h2 className="font-serif text-[#3A4B3C] text-2xl md:text-3xl uppercase tracking-[0.2em] mb-6">
          OUR SPACES
        </h2>
          ...
          {spaces.map((space) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-white drop-shadow-md">
                <h3 className="font-script text-5xl md:text-6xl text-center leading-tight">
                  {space.titleLine1}
                </h3>
                {space.titleLine2 && (
                  <h3 className="font-script text-5xl md:text-6xl text-center leading-tight">
